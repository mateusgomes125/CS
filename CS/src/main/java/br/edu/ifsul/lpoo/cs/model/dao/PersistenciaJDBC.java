...
public class PersistenciaJDBC implements ModeloPersistencia {
    ...
    public void persist(Object o) throws Exception {
           ...
           if (o instanceof Arma) {//Persistencia na tabela municao
            ...
            if (a.getId() == null) {//se não houver registro na tabela
                ...
                ps.setString(1, a.getDescricao()); // parametro 1
                ps.setFloat(2, a.getValor()); // parametro 2
                ps.setFloat(3, a.getCalibre()); // parametro 3
                ps.setInt(4, a.getTipoarma().getId()); // parametro 4
                ps.setInt(5, a.getMunicao().getId()); // parametro 5
                ResultSet rs = ps.executeQuery();// executa o comando sql
                if (rs.next()) {
                    a.setId(rs.getInt("id"));
                }
                   ...
                   PreparedStatement ps = this.con.prepareStatement("update tb_arma set descricao=?, valor=?, calibre=?, "
                   + "tipoarma_id=?, municao_id=? where id=?");//armazenando o comando sql
                   ps.setString(1, a.getDescricao()); //parametro 1 
                   ps.setFloat(2, a.getValor()); //parametro 2
                   ps.setFloat(3, a.getCalibre()); //parametro 3
                   ps.setInt(4, a.getTipoarma().getId()); //parametro 4
